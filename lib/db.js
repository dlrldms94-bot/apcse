...
async function initDatabase() {
  ...
  `);
  await pool.query(`
    ALTER TABLE registrations ADD COLUMN IF NOT EXISTS document_request_urgent BOOLEAN NOT NULL DEFAULT FALSE
  `);
  await pool.query(`
    ALTER TABLE registrations ADD COLUMN IF NOT EXISTS name_en TEXT
  `);
  await pool.query(`
    ALTER TABLE registrations ADD COLUMN IF NOT EXISTS affiliation_en TEXT
  `);
  await pool.query(`
    ALTER TABLE registrations ADD COLUMN IF NOT EXISTS title_en TEXT
  `);
  await pool.query(`
    ALTER TABLE registrations ADD COLUMN IF NOT EXISTS lunch_attendance JSONB
  `);
}
